...
<head>
    ...
    <title>微博互联用户绑定 - <?php echo $zbp->name ?></title>
    <style>
        ...
        <div class="loginwrap">
            ...
            <div class="loginh">
                ...
                <div class="third-logo">
                    <img src="<?php echo $zbp->host; ?>zb_users/plugin/logins/resources/images/sina.png"
                         alt="gitHub绑定用户">
                </div>
            ...
            <form action="<?php echo logins_Event_GetURL('sinaBindAccount') ?>" method="post" id="login_form" onsubmit="return false;">

                <div class="logininput">

                    <input name="username" id="edtUserName" required type="text" class="loginusername" placeholder="邮箱/用户名" ploc="">
            ...
            <div class="login-group">
                ...
                if ($zbp->Config('logins')->sina_user_auto_create == 1) {
                    ...
                    <div class="login-account-create">
                        还没有账户？点这儿<a href="<?php echo logins_Event_GetURL('sinaCreateAccount') ?>" class="login-create">生成账户</a>
                    </div>
                <?php } ?>
            </div>
        </div>
...
<?php }else if($zbp->Config('logins')->theme_id == 1){ ?>
...
<div class="page-container">
    ...
    <h1><?php echo $zbp->name; ?>-微博绑定</h1>

    <form action="<?php echo logins_Event_GetURL( 'sinaBindAccount' ) ?>" method="post" id="login_form">
    ...
    <div class="login-group">
        ...
        if ( $zbp->Config( 'logins' )->sina_user_auto_create == 1 ) {
            ?>
            <div class="login-account-create">
                还没有账户？点这儿<a href="<?php echo logins_Event_GetURL( 'sinaCreateAccount' ) ?>"
