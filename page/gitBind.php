...
<head>
    ...
    <title>gitHub互联用户绑定 - <?php echo $zbp->name ?></title>
</head>
<body>
<?php
        ...
        <div class="loginwrap">
            ...
            <div class="loginh">
                ...
                <div class="third-logo">
                    <img src="<?php echo $zbp->host; ?>zb_users/plugin/logins/resources/icon/giticon/git1.jpeg"
                         alt="gitHub绑定用户">
                </div>
            ...
            <form action="<?php echo logins_Event_GetURL( 'gitBindAccount' ) ?>" method="post" id="login_form"
            ...
            <div class="login-group">
                ...
                if ( $zbp->Config( 'logins' )->git_user_auto_create == 1 ) {
                    ...
                    <div class="login-account-create">
                        还没有账户？点这儿<a href="<?php echo logins_Event_GetURL( 'gitCreateAccount' ) ?>"
...
<div class="page-container">
    ...
    <h1><?php echo $zbp->name; ?>-gitHub绑定</h1>
